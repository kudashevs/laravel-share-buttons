...
class WhatsAppTest extends ExtendedTestCase
{
    ...
    public function it_can_generate_a_whatsapp_share_link_with_all_extra_options()
    {
        $result = ShareButtonsFacade::page('https://mysite.com', '', [
            ...
            ->whatsapp();
        $expected = '<ul><li><a href="https://wa.me/?text=https://mysite.com" class="social-button my-class" id="my-id" title="My Title for SEO" rel="nofollow" target="_blank"><span class="fab fa-whatsapp"></span></a></li></ul>';
