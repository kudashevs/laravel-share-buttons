...
return [
    ...
    'whatsapp' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel" target="_blank"><span class="fab fa-whatsapp"></span></a></li>',
    'pinterest' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-pinterest"></span></a></li>',
    'reddit' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel" target="_blank"><span class="fab fa-reddit"></span></a></li>',
    'telegram' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel" target="_blank"><span class="fab fa-telegram"></span></a></li>',
];
